...
CREATE TABLE [dbo].[Machine_45044] (
...
GO
CREATE NONCLUSTERED INDEX [IX_Machine_45044_CreatedAt]
   ON [dbo].[Machine_45044]([CreatedAt] ASC);
...
DECLARE @MachineCode NVARCHAR(50) = '45044';
DECLARE @MachineName NVARCHAR(100) = 'PINION_SV_NO_02:45044';
